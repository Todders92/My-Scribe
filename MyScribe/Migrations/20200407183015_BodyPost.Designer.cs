...
namespace MyScribe.Migrations
{
    ...
    [Migration("20200407183015_BodyPost")]
    partial class BodyPost
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyScribe.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MyScribe.Models.ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("MyScribe.Models.Board", b =>
                {
                    b.HasOne("MyScribe.Models.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
                });
